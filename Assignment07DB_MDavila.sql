...
-- 2021-05-27,MDavila,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_MDavila')
	 Begin 
	  Alter Database [Assignment07DB_MDavila] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_MDavila;
	 End
	Create Database Assignment07DB_MDavila;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_MDavila;
